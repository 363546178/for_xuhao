...
void SRUKF::setR(MatrixXf _R)
{
	R=_R;
}

void SRUKF::setQ(MatrixXf _Q)
{
	Q=_Q;
}

void SRUKF::setMeasurementFunc(void (*_h_func)(VectorXf&, const VectorXf&))
{
	h_func=_h_func;
}

void SRUKF::predict(const VectorXf& a, const float dt)
{
